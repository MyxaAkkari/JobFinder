...
// Retrieve the job email from the query parameter
var urlParams = new URLSearchParams(window.location.search);
var jobEmail = urlParams.get("email");

// Now you can use the jobEmail in your form submission logic
// For example, you can set it as the default value in an input field:
document.getElementById("email").value = jobEmail;
    ...
    var mailtoLink = "mailto:" + jobEmail + "?subject=" + encodedSubject + "&body=" + encodedBody;
